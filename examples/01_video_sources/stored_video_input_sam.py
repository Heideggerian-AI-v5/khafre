...
def main():
    ...
    procs["objP"] = ByteTracker(segmenter=SegmentAnythingWrapper())#YOLOObjectSegmentationWrapper()
    ...
    # A bit of a hack -- just set goals here as opposed to via an "official" channel.
    procs["objP"]._currentGoals = [("find", "foil", ""), ("find", "fork", ""), ("find", "mouse", ""), ("find", "hand", "")]
